...
const DEFAULT_COLORS = ['#030303', '#7980DA', '#C8B9E0', '#9060FF', '#4080FF'];
...
`;
    ...
    if(isBFECC == false){
        ...
        gl_FragColor = vec4(newVel2 * dissipation, 0.0, 1.0);
    }
}
`;
    const color_frag = `
...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt, isBounce, BFECC }: any) {
        ...
        this.uniforms.dissipation.value = 0.94; // Default dissipation
        super.update();
      }
    }
