  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      if (isWebGL2) {
        ...
        formatRG = getSupportedFormat(gl, (gl as any).RGBA, gl.RGBA, halfFloatTexType);
        formatR = getSupportedFormat(gl, (gl as any).RGBA, gl.RGBA, halfFloatTexType);
      }
    ...
    function clickSplat(pointer: any) {
      ...
      // Reduced intensity to keep colors true to the palette and avoid white blowouts
      color.r *= 1.5;
      color.g *= 1.5;
      color.b *= 1.5;
    ...
    const PALETTE = [
      { r: 0.4745, g: 0.5020, b: 0.8549 }, // Vibrant Primary Purple (#7980DA)
      { r: 0.7843, g: 0.7255, b: 0.8784 }, // Vibrant Lilac (#C8B9E0)
      { r: 0.9000, g: 0.6000, b: 1.0000 }, // Glowing Neon Purple
      { r: 0.4000, g: 0.8000, b: 1.0000 }  // Electric Cyan/Blue
    ];
  ...
  return (
    <div
      style={{
        ...
        width: '100%',
        height: '100%',
        opacity: 0.8 // More vibrant and visible effect
      }}
    >
      <canvas
        ref={canvasRef}
